...
const projects: Project[] = [
  {
    ...
    image_url: "https://thullydev.github.io/thullyDevStatics/images/mangarealm-logo.png",
    slug: "animehub"
  },
  {
    name: "MangaWorld",
...
export function getProjects({ page }: GetProjects): GetProjectsResponse {
	const { items: pagenatedProjects, pagination } = paginateItems({ data: projects, page: page, limit: 6 })
